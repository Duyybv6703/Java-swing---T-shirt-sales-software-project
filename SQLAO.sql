create DATABASE SQL_BAN_AO_main
GO
...
CONSTRAINT FK_HOADON_khuyenmai FOREIGN KEY (idkm) REFERENCES khuyenmai
)
go
...
( N'Size L'),
( N'Size XL')
INSERT INTO CHITIETSANPHAM (MASP, MAMS, MACL, MASIZE, HINHANH, SOLUONG, GIA, MOTA)
VALUES
('SP01', 1, 1, 1, '/images/ao-so-mi-trang.jpg', 10, 200000, 'Áo sơ mi nam màu trắng, chất liệu cotton'),
('SP02', 2, 2, 2, '/images/ao-phong-den.jpg', 5, 150000, 'Áo phông nam màu đen, chất liệu cotton'),
('SP03', 3, 1, 3, '/images/ao-gio-xanh-duong.jpg', 20, 300000, 'Áo gió nam màu xanh dương, chất liệu kaki' )
...
INSERT INTO NHANVIEN (MATK, TENNV, SDT, GIOITINH, DIACHI,gmail)
VALUES
('1', N'Nhân viên 1', '0123456789', 1, N'Số 3, đường Trần Hưng Đạo, Đà Nẵng','anhttph40973@gmail.com'),
('2', N'Nhân viên 2', '0987654321', 0, N'Số 4, đường Bà Triệu, TP. Hải Phòng','anhttph40973@fpt.edu.com'),
('3', N'mr quan lý', '0123242343', 0, N'Số 4, đường Bà Triệu, TP. Hải Phòng','locnhph38787@fpt.edu.vn')
INSERT INTO HOADON (MANV, MAKH, NGAYTAO,TRANGTHAI,tongtien)
VALUES
(1, 1, '2023-11-10',N'Đã thanh toán',10000),
(2, 2, '2023-11-11',N'Đã thanh toán',10000);
...
VALUES
(N'mã khuyến mãi ngày cuối tuần','hGdhyLequOAqpSq',20000, '2023-12-1','2023-12-3', N'đã quá hạn'),
(N'mã khuyến mãi ngày cuối tuần','YBYfjQhvODJDsco',15000, '2023-12-1','2023-12-3', N'đã quá hạn')
...
---
			...
			select TENTK,gmail from NHANVIEN join TAIKHOAN on nhanvien.MATK = TAIKHOAN.MATK
			where gmail = 'anhttph40973@gmail.com'
